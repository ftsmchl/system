...
case $HOSTNAME in
	...
	(system_host_7)
		node host_server/host_server.js >> logs/host_server.out &
		sleep 1
		./sysclient accountAdd  0x5aff1d56bC44898c28f94Ba6018cBc49718a666E >> logs/sysclient.out
		sleep 31 
		./sysclient host findContracts
		;;
	(system_host_8)
		node host_server/host_server.js >> logs/host_server.out &
		sleep 1
		./sysclient accountAdd  0x713fa87Ac59d7F5D3DD569C802419CC62643Ddbe >> logs/sysclient.out
		sleep 32 
		./sysclient host findContracts
		;;
